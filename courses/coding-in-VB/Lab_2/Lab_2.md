...
## Introduction
Write a VB program that prints the coordinates of a chessboard to the terminal.
...
Your task is to write a VB program that prints all chessboard fields in the following format:
